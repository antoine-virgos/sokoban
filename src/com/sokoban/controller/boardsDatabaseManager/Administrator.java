...
import com.sokoban.controller.boardBuild.BoardBuildException;
import com.sokoban.controller.boardBuild.FileBoardBuilder;
...
public class Administrator {
     ...
     */
    public static void main(String[] args) throws BoardCellException, BoardBuildException {
        ...
        while (loop) {
            ...
            OUT.println();
            switch (command) {
                case "1": executeCreateDBCommand(); break;
                case "2": executeListCommand(); break;
                case "3": executeShowCommand(); break;
                case "4": executeAddCommand(); break;
                case "5": executeRemoveCommand(); break;
     ...
     * @throws BoardBuildException the board cannot be built
     */
    private static void executeAddCommand() throws BoardCellException, BoardBuildException {
        // ID
        OUT.println("Enter the board ID : ");
        String idAdd = read();
        OUT.print("\n");
        ...
        fileBuilder.readFileBoardInformation();
    ...
    private static void listBoardsInDirectory(File directory) {
        ...
        if (files != null) {
            ...
            OUT.println("Unknown directory : " + directory);
        }
    }
}